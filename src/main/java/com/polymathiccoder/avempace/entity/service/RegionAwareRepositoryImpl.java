...
public class RegionAwareRepositoryImpl<T> implements RegionAwareRepository<T> {
// Fields
...
// Life cycle
	public RegionAwareRepositoryImpl(final DynamoDBDDLOperationsService dynamoDBDDLOperationsService, final DynamoDBDMLOperationsService dynamoDBDMLOperationsService, final Model<T> model) {
...
// Behavior
	@Override
	public T find(final EntityPropertyValueCriteria entityPropertyValueCriteria, final Region region) {
	...
	@Override
	public List<T> findAllBy(final EntityPropertyValueCriteria entityPropertyValueCriteria, final Region region) {
		final TableDefinition tableDefinition = model.getMapping().getTableDefinition();
	...
	@Override
	public List<T> findAll(final Region region) {
		return findAllBy(EntityPropertyValueCriteria.anything(), region);
	}

	@Override
	public void save(final T pojo, final Region region) {
	...
	@Override
	public void update(final EntityPropertyValueCriteria entityPropertyValueCriteria, final EntityPropertyValueOperations entityPropertyValueOperations, final Region region) {
		final TableDefinition tableDefinition = model.getMapping().getTableDefinition();
		final Table table = Table.Builder
				.create(tableDefinition, region)
				.build();
	...
	@Override
	public void remove(final T pojo, final Region region) {
		final  Entity<T> entity = Entity.create(pojo, region);
		final Tuple tuple = Tuple.create(entity);
	...
	@Override
	public void drop(final Region region) {
		final TableDefinition tableDefinition =model.getMapping().getTableDefinition();
		final Table table = Table.Builder.create(tableDefinition, region).build();
